...
public class FindTeammate extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState){
	    ...
	    setContentView(R.layout.find_teammate);
	    ...
	    postButton = (Button)findViewById(R.id.find_teammate_post_button);
		...
		((Button)findViewById(R.id.search_player_button)).setOnClickListener(new OnClickListener(){
	    	@Override
			public void onClick(View arg0){
				Intent intent = new Intent(FindTeammate.this, SearchPlayer.class);
